  ...
  outputs = inputs @ {
    ...
    users = {
      konrad = {
        ...
        hashedPassword = "$6$RBkhi5gvJJLHJTBn$ojlhMXapoCOT5yxluwWGdpluOO0hU1SN8VGSlRuG/oDG8ZK48R7fz7ckaj7D7x9CHjDpe/1Y9EvL16rT939Nc0"; # sha-512 crypt
        authorizedKeys = [
          "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHQIxedvPAE7xnIc+n4y/2Bd1Kg9XJuorK0QvSIBJTM4 konrad@konrad-server"
