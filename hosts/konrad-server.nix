{
  ...
  # Avoid sops-install-secrets failing due to missing SSH keys
  ...
  # SSH Reverse Tunnel for Minecraft
  systemd.services.minecraft-tunnel = {
    ...
    serviceConfig = {
      User = "konrad";
      ExecStart = "${pkgs.openssh}/bin/ssh -N -R 0.0.0.0:25565:localhost:25565 -o ServerAliveInterval=60 -o ExitOnForwardFailure=yes root@82.165.143.27";
      Restart = "always";
      RestartSec = "10";
    };
  };
  ...
  virtualisation.oci-containers.containers = {
    ...
    */
    ...
    wireguard-ui = {
      ...
      environmentFiles = [
        config.sops.secrets.wguiENV.path
      ];
      environment = {
        WGUI_USERNAME = "admin";
